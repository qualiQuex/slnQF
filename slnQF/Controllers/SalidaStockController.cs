...
{
    public class SalidaStockController : Controller
    {
        // GET: EntradaStock
        ...
        public JsonResult creaSalidaStock(string jsonStringItems, string jsonStringLotes, string pserie, string pnumero)
        {
            ...
            if (v_band > 0)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        Documents v_StockEntry = oCompany.GetBusinessObject(BoObjectTypes.oInventoryGenExit);
                       ...
                       // SAPbobsCOM.InventoryGenEntry v_StockEntry2 = (InventoryGenEntry)oCompany.GetBusinessObject(BoObjectTypes.oInventoryGenEntry);
                        ...
                        v_StockEntry.JournalMemo = "Salida de mercancías";
