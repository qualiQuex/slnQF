...
{
    public class EntradaStockController : Controller
    {
        // GET: EntradaStock
        ...
        public JsonResult creaEntradaStock(string jsonStringItems, string jsonStringLotes, string pserie, string pnumero)
        {
            ...
            if (v_band > 0)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        Documents v_StockEntry = oCompany.GetBusinessObject(BoObjectTypes.oInventoryGenEntry);


                       // SAPbobsCOM.InventoryGenEntry v_StockEntry2 = (InventoryGenEntry)oCompany.GetBusinessObject(BoObjectTypes.oInventoryGenEntry);
                        int vLinea = 0;
                        ...
                        v_StockEntry.JournalMemo = "Entrada de mercancías";
                        ...
                        foreach (itemTransferenciaStock item in dynJsonItem)
                        {
                            ...
                            try
                            {
                                ...
                                foreach (reciboclsLoteSeleccionado itemLote in dynJsonLote.Where(x => x.ITEMCODE == item.ITEMCODE))
                                {
                                    ...
                                    v_StockEntry.Lines.BatchNumbers.ManufacturerSerialNumber = itemLote.MNFSERIAL;
